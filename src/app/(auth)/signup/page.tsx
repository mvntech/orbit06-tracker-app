...
export default function SignUpPage() {
  ...
  if (success) {
    return (
      <div className="bg-card rounded-xl shadow-lg p-8 border-2 border-border text-center">
        ...
        <p className="text-sm text-muted-foreground">
          Click the link in the email to activate your account and start your 2026 journey!
        </p>
        <Link 
          href="/login"
          className="inline-block mt-6 text-primary font-semibold hover:underline underline-offset-4"
        >
          ← Back to login
        </Link>
      </div>
    ...
    <div className="bg-card rounded-xl shadow-lg p-8 border-2 border-border">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground text-sm">
          Create your Orbit06 account for 2026
        </p>
      </div>
